...
void move_infos_box(st_rpg *s)
{
	...
	sfVector2f pos_quests_box_text = create_vector2f(pos_quests_box.x + 10, pos_quests_box.y + 10);
	sfVector2f pos_quests_des = create_vector2f(s->fi->camera.x - 960, s->fi->camera.y - 510 + s->fi->quests_box.quests_box->obj->rect.height);
	sfVector2f pos_quests_des_text = create_vector2f(pos_quests_box.x + 10, pos_quests_box.y + 90);
