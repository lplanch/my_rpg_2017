...
{
	if ((fi->characters->pos.x <= 960 && fi->characters->pos.x >= 136 && fi->characters->pos.y >= 24 && fi->characters->pos.y <= 3100) || (fi->characters->pos.x <= 6719 && fi->characters->pos.x >= 6216 && fi->characters->pos.y >= 3709 && fi->characters->pos.y <= 5970))
		fi->camera_pos = 2;
	if ((fi->characters->pos.x >= 8634 && fi->characters->pos.x <= 9378 && fi->characters->pos.y >= 24 && fi->characters->pos.y <= 3100) || (fi->characters->pos.x <= 8708 && fi->characters->pos.x >= 7840 && fi->characters->pos.y >= 3709 && fi->characters->pos.y <= 5970))
		fi->camera_pos = 2;
	...
	if ((fi->characters->pos.y >= 2740 && fi->characters->pos.y <= 3100 && fi->characters->pos.x >= 136 && fi->characters->pos.x <= 9378) || (fi->characters->pos.y <= 3915 && fi->characters->pos.y >= 3709 && fi->characters->pos.x >= 6270 && fi->characters->pos.x <= 8708))
		fi->camera_pos = 3;
